...
Diesel & Regular engine cars had their peak at 1990s, Premium fuel cars 2008v666AZ and Electric cars start emerging their popularity after 2010.
...
pp  <- big_epa_cars %>% mutate(fuelType=fct_reorder(fuelType, year)) %>% ggplot(aes(x=fuelType, y =year, fill=fuelType)) + geom_boxplot(varwidth=TRUE) + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + coord_flip()
pp


# Grouped: Electric vs no electric: Ordered
